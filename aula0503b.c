...
Descricao: Programa de testes para funcao ValidarRg atraves de um unico argumento
...
main (int argc, char *argv[])
{
    ...
    for (indice = indicePrint = 0; indicePrint < COMPRIMENTO_RG + 3; indicePrint++)
	{
